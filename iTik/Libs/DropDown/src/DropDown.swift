...
public final class DropDown: UIView {
	...
	*/
	...
	The background color of the selected cell in the drop down.
     ...
     Changing the background color automatically reloads th@objc e drop down.
	*/
	...
	The separator color between cells.
     ...
     Changing the separator color automatically reloads th@objc e drop down.
	*/
	...
	The corner radius of DropDown.
     ...
     Changing the corner radius automatically reloads th@objc e drop down.
	*/
	...
	The color of the shadow.
     ...
     Changing the shadow color automatically reloads th@objc e drop down.
	*/
	...
	*/
	...
	The opacity of the shadow.
     ...
     Changing the shadow opacity automatically reloads th@objc e drop down.
	*/
	...
	The radius of the shadow.
     ...
     Changing the shadow radius automatically reloads th@objc e drop down.
	*/
	...
	*/
	...
	The color of the text for each cells of the drop down.
     ...
     Changing the text color automatically reloads th@objc e drop down.
	*/
	...
	The font of the text for each cells of the drop down.
     ...
     Changing the text font automatically reloads th@objc e drop down.
	*/
